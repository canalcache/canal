...
@x = common global i8 0, align 64
@y = common global i8 0, align 64
@t = common global i8 0, align 64
@.str12 = private unnamed_addr constant [3 x i8] c"x2\00", align 1
@.str13 = private unnamed_addr constant [3 x i8] c"x1\00", align 1
@.str14 = private unnamed_addr constant [3 x i8] c"y2\00", align 1
@.str15 = private unnamed_addr constant [3 x i8] c"y1\00", align 1
@.str16 = private unnamed_addr constant [19 x i8] c"access1 == access2\00", align 1
@.str17 = private unnamed_addr constant [6 x i8] c"tmp.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str18 = private unnamed_addr constant [15 x i8] c"miss1 == miss2\00", align 1
@.str19 = private unnamed_addr constant [12 x i8] c"klee_choose\00", align 1
@.str120 = private unnamed_addr constant [57 x i8] c"/home/gpsim/klee/runtime/Intrinsic/klee_div_zero_check.c\00", align 1
@.str1221 = private unnamed_addr constant [15 x i8] c"divide by zero\00", align 1
@.str222 = private unnamed_addr constant [8 x i8] c"div.err\00", align 1
@.str323 = private unnamed_addr constant [8 x i8] c"IGNORED\00", align 1
@.str1424 = private unnamed_addr constant [16 x i8] c"overshift error\00", align 1
@.str25 = private unnamed_addr constant [14 x i8] c"overshift.err\00", align 1
@.str625 = private unnamed_addr constant [48 x i8] c"/home/gpsim/klee/runtime/Intrinsic/klee_range.c\00", align 1
@.str1726 = private unnamed_addr constant [14 x i8] c"invalid range\00", align 1
...
; Function Attrs: nounwind uwtable
define void @__CSIM_MAIN__(i8 signext %xt, i8 signext %yt) #0 {
CH_STB:
  %0 = alloca i8, align 1
  %1 = alloca i8, align 1
  store i8 %xt, i8* %0, align 1
  store i8 %yt, i8* %1, align 1
  %2 = load i8* %0, align 1
  store i8 %2, i8* @x, align 64
  call void @__CSIM_Store(i64 24586, i64 2)
  %3 = load i8* %1, align 1
  store i8 %3, i8* @y, align 64
  call void @__CSIM_Store(i64 24586, i64 3)
  %4 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  %5 = sext i8 %4 to i32
  %6 = icmp sgt i32 %5, 0
  br i1 %6, label %CH_LDB6, label %38

CH_LDB6:                                          ; preds = %CH_STB
  %7 = load i8* @x, align 64
  call void @__CSIM_Load(i64 24586, i64 2)
  %8 = sext i8 %7 to i32
  %9 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  %10 = sext i8 %9 to i32
  ...
  %11 = srem i32 %8, %10
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %CH_LDB8, label %38

CH_LDB8:                                          ; preds = %CH_LDB6
  %13 = load i8* @x, align 64
  call void @__CSIM_Load(i64 24586, i64 2)
  %14 = sext i8 %13 to i32
  %15 = icmp slt i32 %14, 0
  br i1 %15, label %CH_LDB9, label %CH_LDB10

CH_LDB9:                                          ; preds = %CH_LDB8
  %16 = load i8* @x, align 64
  call void @__CSIM_Load(i64 24586, i64 2)
  %17 = sext i8 %16 to i32
  %18 = sub nsw i32 0, %17
  %19 = trunc i32 %18 to i8
  store i8 %19, i8* @x, align 64
  call void @__CSIM_Store(i64 24586, i64 2)
  br label %CH_LDB10

CH_LDB10:                                         ; preds = %CH_LDB9, %CH_LDB8
  %20 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  %21 = sext i8 %20 to i32
  %22 = icmp slt i32 %21, 0
  br i1 %22, label %CH_LDB11, label %CH_LDB12

CH_LDB11:                                         ; preds = %CH_LDB10
  %23 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  %24 = sext i8 %23 to i32
  %25 = sub nsw i32 0, %24
  %26 = trunc i32 %25 to i8
  store i8 %26, i8* @y, align 64
  call void @__CSIM_Store(i64 24586, i64 3)
  br label %CH_LDB12

CH_LDB12:                                         ; preds = %CH_LDB10, %CH_LDB11, %CH_LDB13
  %27 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  %28 = sext i8 %27 to i32
  %29 = icmp ne i32 %28, 0
  br i1 %29, label %CH_LDB13, label %38

CH_LDB13:                                         ; preds = %CH_LDB12
  %30 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  store i8 %30, i8* @t, align 64
  call void @__CSIM_Store(i64 24586, i64 1)
  %31 = load i8* @x, align 64
  call void @__CSIM_Load(i64 24586, i64 2)
  %32 = sext i8 %31 to i32
  %33 = load i8* @y, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  ...
  store i8 %36, i8* @y, align 64
  call void @__CSIM_Store(i64 24586, i64 3)
  %37 = load i8* @t, align 64
  call void @__CSIM_Load(i64 24586, i64 1)
  store i8 %37, i8* @x, align 64
  call void @__CSIM_Store(i64 24586, i64 2)
  br label %CH_LDB12

; <label>:38                                      ; preds = %CH_LDB12, %CH_LDB6, %CH_STB
  ret void
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  call void @klee_make_symbolic(i8* %x2, i64 1, i8* getelementptr inbounds ([3 x i8]* @.str12, i32 0, i32 0))
  call void @klee_make_symbolic(i8* %x1, i64 1, i8* getelementptr inbounds ([3 x i8]* @.str13, i32 0, i32 0))
  call void @klee_make_symbolic(i8* %y2, i64 1, i8* getelementptr inbounds ([3 x i8]* @.str14, i32 0, i32 0))
  call void @klee_make_symbolic(i8* %y1, i64 1, i8* getelementptr inbounds ([3 x i8]* @.str15, i32 0, i32 0))
  call void @__CSIM_init_cache()
  %2 = load i8* %x1, align 1
  %3 = load i8* %y1, align 1
  call void @__CSIM_MAIN__(i8 signext %2, i8 signext %3)
  %4 = load i32* @__CSIM_num_Store_hit, align 4
  %5 = load i32* @__CSIM_num_Store_miss, align 4
  %6 = add i32 %4, %5
  %7 = load i32* @__CSIM_num_Load_hit, align 4
  %8 = add i32 %6, %7
  %9 = load i32* @__CSIM_num_Load_miss, align 4
  %10 = add i32 %8, %9
  store i32 %10, i32* %access1, align 4
  %11 = load i32* @__CSIM_num_Store_miss, align 4
  %12 = load i32* @__CSIM_num_Load_miss, align 4
  %13 = add i32 %11, %12
  store i32 %13, i32* %miss1, align 4
  call void @__CSIM_init_cache()
  %14 = load i8* %x2, align 1
  %15 = load i8* %y2, align 1
  call void @__CSIM_MAIN__(i8 signext %14, i8 signext %15)
...
; <label>:29                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8]* @.str16, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str17, i32 0, i32 0), i32 55, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
...
; <label>:34                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str18, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str17, i32 0, i32 0), i32 56, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
...
define i64 @klee_choose(i64 %n) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str19, i64 0, i64 0)) #7
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([57 x i8]* @.str120, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1221, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str222, i64 0, i64 0)) #8
  unreachable
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str323, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str1424, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #8
  unreachable
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([48 x i8]* @.str625, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str1726, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #8
  unreachable
