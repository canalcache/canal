...
; Function Attrs: nounwind uwtable
define void @__CSIM_MAIN__(i8 signext %x, i8 signext %y) #0 {
CH_STB:
  %0 = alloca i8, align 1
  %1 = alloca i8, align 1
  ...
  %3 = sext i8 %2 to i32
  %4 = icmp sgt i32 %3, 0
  br i1 %4, label %CH_LDB2, label %36

CH_LDB2:                                          ; preds = %CH_STB
  %5 = load i8* %0, align 1
  %6 = sext i8 %5 to i32
  %7 = load i8* %1, align 1
  %8 = sext i8 %7 to i32
  ...
  %9 = srem i32 %6, %8
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %CH_LDB4, label %36

CH_LDB4:                                          ; preds = %CH_LDB2
  %11 = load i8* %0, align 1
  %12 = sext i8 %11 to i32
  %13 = icmp slt i32 %12, 0
  br i1 %13, label %CH_LDB5, label %CH_LDB6
...
CH_LDB6:                                          ; preds = %CH_LDB5, %CH_LDB4
  %18 = load i8* %1, align 1
  %19 = sext i8 %18 to i32
  %20 = icmp slt i32 %19, 0
  br i1 %20, label %CH_LDB7, label %CH_LDB8
...
CH_LDB8:                                          ; preds = %CH_LDB6, %CH_LDB7, %CH_LDB9
  %25 = load i8* %1, align 1
  %26 = sext i8 %25 to i32
  %27 = icmp ne i32 %26, 0
  br i1 %27, label %CH_LDB9, label %36

CH_LDB9:                                          ; preds = %CH_LDB8
  %28 = load i8* %1, align 1
  store i8 %28, i8* @t, align 64
  call void @__CSIM_Store(i64 24585, i64 3)
  %29 = load i8* %0, align 1
  ...
  %35 = load i8* @t, align 64
  call void @__CSIM_Load(i64 24585, i64 3)
  store i8 %35, i8* %0, align 1
  br label %CH_LDB8

; <label>:36                                      ; preds = %CH_LDB8, %CH_LDB2, %CH_STB
  ret void
}
...
; <label>:29                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8]* @.str16, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str17, i32 0, i32 0), i32 50, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
...
; <label>:34                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str18, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str17, i32 0, i32 0), i32 51, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
