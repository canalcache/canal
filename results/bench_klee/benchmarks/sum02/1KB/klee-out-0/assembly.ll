...
; Function Attrs: nounwind uwtable
define void @__CSIM_MAIN__(i32 %i) #0 {
CH_STB:
  %0 = alloca i32, align 4
  store i32 %i, i32* %0, align 4
  store i32 5, i32* @n, align 64
  call void @__CSIM_Store(i64 24585, i64 1)
  store i32 0, i32* @sn, align 64
  call void @__CSIM_Store(i64 24585, i64 2)
  br label %CH_LDB

CH_LDB:                                           ; preds = %CH_LDB3, %CH_STB
  %1 = load i32* %0, align 4
  %2 = load i32* @n, align 64
  call void @__CSIM_Load(i64 24585, i64 1)
  %3 = icmp ule i32 %1, %2
  br i1 %3, label %CH_LDB3, label %9

CH_LDB3:                                          ; preds = %CH_LDB
  %4 = load i32* @sn, align 64
  call void @__CSIM_Load(i64 24585, i64 2)
  %5 = load i32* %0, align 4
  %6 = add i32 %4, %5
  store i32 %6, i32* @sn, align 64
  call void @__CSIM_Store(i64 24585, i64 2)
...
; <label>:29                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8]* @.str14, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str15, i32 0, i32 0), i32 53, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
...
; <label>:34                                      ; preds = %30
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str16, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str15, i32 0, i32 0), i32 54, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
