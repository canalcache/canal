...
; Function Attrs: nounwind uwtable
define void @__CSIM_MAIN__(i32 %multi) #0 {
CH_STB:
  %0 = alloca i32, align 4
  store i32 %multi, i32* %0, align 4
  store i32 0, i32* @i, align 64
  call void @__CSIM_Store(i64 24588, i64 3)
  br label %CH_LDB

CH_LDB:                                           ; preds = %CH_STB2, %CH_STB
  %1 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24588, i64 3)
  %2 = icmp slt i32 %1, 200
  br i1 %2, label %CH_LDB1, label %8

CH_LDB1:                                          ; preds = %CH_LDB
  %3 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24588, i64 3)
  %4 = sext i32 %3 to i64
  %5 = getelementptr inbounds [200 x i32]* @a, i32 0, i64 %4
  store i32 1, i32* %5, align 4
  %CH_OFFSET = mul i64 4, %4
  %CH_LEFT = add i64 %CH_OFFSET, 6293888
  %CH_COND = icmp ult i64 %CH_LEFT, 6293952
  br i1 %CH_COND, label %CH_TRUE_BLOCK, label %CH_ELSE_BLOCK

CH_STB2:                                          ; preds = %CH_TRUE_BLOCK69, %CH_TRUE_BLOCK68, %CH_ELSE_BLOCK64, %CH_TRUE_BLOCK63, %CH_TRUE_BLOCK58, %CH_TRUE_BLOCK53, %CH_TRUE_BLOCK48, %CH_TRUE_BLOCK43, %CH_TRUE_BLOCK38, %CH_TRUE_BLOCK33, %CH_TRUE_BLOCK
  %6 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24588, i64 3)
  %7 = add nsw i32 %6, 1
  store i32 %7, i32* @i, align 64
  call void @__CSIM_Store(i64 24588, i64 3)
  br label %CH_LDB

; <label>:8                                       ; preds = %CH_LDB
  store i32 0, i32* @i, align 64
  call void @__CSIM_Store(i64 24588, i64 3)
  br label %CH_LDB4

CH_LDB4:                                          ; preds = %CH_LDB10, %8
  %9 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24588, i64 3)
  %10 = icmp slt i32 %9, 12
  br i1 %10, label %CH_LDB5, label %25

CH_LDB5:                                          ; preds = %CH_LDB4
  ...
  %14 = srem i32 %11, %13
  %15 = icmp eq i32 %14, 0
  %16 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24588, i64 3)
  br i1 %15, label %CH_LDB7, label %CH_LDB8

CH_LDB7:                                          ; preds = %CH_LDB5
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds [200 x i32]* @a, i32 0, i64 %17
  store i32 42, i32* %18, align 4
  %CH_OFFSET70 = mul i64 4, %17
  %CH_LEFT71 = add i64 %CH_OFFSET70, 6293888
  %CH_COND72 = icmp ult i64 %CH_LEFT71, 6293952
  br i1 %CH_COND72, label %CH_TRUE_BLOCK77, label %CH_ELSE_BLOCK73

CH_LDB8:                                          ; preds = %CH_LDB5
  %19 = load i32* %0, align 4
  %20 = mul nsw i32 %16, %19
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [200 x i32]* @a, i32 0, i64 %21
  store i32 42, i32* %22, align 4
  %CH_OFFSET134 = mul i64 4, %21
  %CH_LEFT135 = add i64 %CH_OFFSET134, 6293888
  %CH_COND136 = icmp ult i64 %CH_LEFT135, 6293952
  br i1 %CH_COND136, label %CH_TRUE_BLOCK141, label %CH_ELSE_BLOCK137

CH_LDB10:                                         ; preds = %CH_TRUE_BLOCK197, %CH_TRUE_BLOCK196, %CH_ELSE_BLOCK192, %CH_TRUE_BLOCK191, %CH_TRUE_BLOCK186, %CH_TRUE_BLOCK181, %CH_TRUE_BLOCK176, %CH_TRUE_BLOCK171, %CH_TRUE_BLOCK166, %CH_TRUE_BLOCK161, %CH_
  %23 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24588, i64 3)
  %24 = add nsw i32 %23, 1
  store i32 %24, i32* @i, align 64
  call void @__CSIM_Store(i64 24588, i64 3)
  br label %CH_LDB4

; <label>:25                                      ; preds = %CH_LDB4
  ret void

CH_ELSE_BLOCK:                                    ; preds = %CH_LDB1
  %CH_OFFSET11 = mul i64 4, %4
  %CH_LEFT12 = add i64 %CH_OFFSET11, 6293888
  %CH_COND13 = icmp ult i64 %CH_LEFT12, 6294016
  br i1 %CH_COND13, label %CH_TRUE_BLOCK18, label %CH_ELSE_BLOCK14

CH_TRUE_BLOCK:                                    ; preds = %CH_LDB1
  call void @__CSIM_Store(i64 24585, i64 2)
  br label %CH_STB2

CH_ELSE_BLOCK14:                                  ; preds = %CH_ELSE_BLOCK
  %CH_OFFSET15 = mul i64 4, %4
  %CH_LEFT16 = add i64 %CH_OFFSET15, 6293888
  %CH_COND17 = icmp ult i64 %CH_LEFT16, 6294080
  br i1 %CH_COND17, label %CH_TRUE_BLOCK23, label %CH_ELSE_BLOCK19

CH_TRUE_BLOCK18:                                  ; preds = %CH_ELSE_BLOCK
  call void @__CSIM_Store(i64 24585, i64 3)
  br label %CH_STB2

CH_ELSE_BLOCK19:                                  ; preds = %CH_ELSE_BLOCK14
  %CH_OFFSET20 = mul i64 4, %4
  %CH_LEFT21 = add i64 %CH_OFFSET20, 6293888
  %CH_COND22 = icmp ult i64 %CH_LEFT21, 6294144
  br i1 %CH_COND22, label %CH_TRUE_BLOCK28, label %CH_ELSE_BLOCK24

CH_TRUE_BLOCK23:                                  ; preds = %CH_ELSE_BLOCK14
  call void @__CSIM_Store(i64 24586, i64 0)
  br label %CH_STB2

CH_ELSE_BLOCK24:                                  ; preds = %CH_ELSE_BLOCK19
  %CH_OFFSET25 = mul i64 4, %4
  %CH_LEFT26 = add i64 %CH_OFFSET25, 6293888
  %CH_COND27 = icmp ult i64 %CH_LEFT26, 6294208
  br i1 %CH_COND27, label %CH_TRUE_BLOCK33, label %CH_ELSE_BLOCK29

CH_TRUE_BLOCK28:                                  ; preds = %CH_ELSE_BLOCK19
  call void @__CSIM_Store(i64 24586, i64 1)
  br label %CH_STB2

CH_ELSE_BLOCK29:                                  ; preds = %CH_ELSE_BLOCK24
  %CH_OFFSET30 = mul i64 4, %4
  %CH_LEFT31 = add i64 %CH_OFFSET30, 6293888
  %CH_COND32 = icmp ult i64 %CH_LEFT31, 6294272
  br i1 %CH_COND32, label %CH_TRUE_BLOCK38, label %CH_ELSE_BLOCK34

CH_TRUE_BLOCK33:                                  ; preds = %CH_ELSE_BLOCK24
  call void @__CSIM_Store(i64 24586, i64 2)
  br label %CH_STB2

CH_ELSE_BLOCK34:                                  ; preds = %CH_ELSE_BLOCK29
  %CH_OFFSET35 = mul i64 4, %4
  %CH_LEFT36 = add i64 %CH_OFFSET35, 6293888
  %CH_COND37 = icmp ult i64 %CH_LEFT36, 6294336
  br i1 %CH_COND37, label %CH_TRUE_BLOCK43, label %CH_ELSE_BLOCK39

CH_TRUE_BLOCK38:                                  ; preds = %CH_ELSE_BLOCK29
  call void @__CSIM_Store(i64 24586, i64 3)
  br label %CH_STB2

CH_ELSE_BLOCK39:                                  ; preds = %CH_ELSE_BLOCK34
  %CH_OFFSET40 = mul i64 4, %4
  %CH_LEFT41 = add i64 %CH_OFFSET40, 6293888
  %CH_COND42 = icmp ult i64 %CH_LEFT41, 6294400
  br i1 %CH_COND42, label %CH_TRUE_BLOCK48, label %CH_ELSE_BLOCK44

CH_TRUE_BLOCK43:                                  ; preds = %CH_ELSE_BLOCK34
  call void @__CSIM_Store(i64 24587, i64 0)
  br label %CH_STB2

CH_ELSE_BLOCK44:                                  ; preds = %CH_ELSE_BLOCK39
  %CH_OFFSET45 = mul i64 4, %4
  %CH_LEFT46 = add i64 %CH_OFFSET45, 6293888
  %CH_COND47 = icmp ult i64 %CH_LEFT46, 6294464
  br i1 %CH_COND47, label %CH_TRUE_BLOCK53, label %CH_ELSE_BLOCK49

CH_TRUE_BLOCK48:                                  ; preds = %CH_ELSE_BLOCK39
  call void @__CSIM_Store(i64 24587, i64 1)
  br label %CH_STB2

CH_ELSE_BLOCK49:                                  ; preds = %CH_ELSE_BLOCK44
  %CH_OFFSET50 = mul i64 4, %4
  %CH_LEFT51 = add i64 %CH_OFFSET50, 6293888
  %CH_COND52 = icmp ult i64 %CH_LEFT51, 6294528
  br i1 %CH_COND52, label %CH_TRUE_BLOCK58, label %CH_ELSE_BLOCK54

CH_TRUE_BLOCK53:                                  ; preds = %CH_ELSE_BLOCK44
  call void @__CSIM_Store(i64 24587, i64 2)
  br label %CH_STB2

CH_ELSE_BLOCK54:                                  ; preds = %CH_ELSE_BLOCK49
  %CH_OFFSET55 = mul i64 4, %4
  %CH_LEFT56 = add i64 %CH_OFFSET55, 6293888
  %CH_COND57 = icmp ult i64 %CH_LEFT56, 6294592
  br i1 %CH_COND57, label %CH_TRUE_BLOCK63, label %CH_ELSE_BLOCK59

CH_TRUE_BLOCK58:                                  ; preds = %CH_ELSE_BLOCK49
  call void @__CSIM_Store(i64 24587, i64 3)
  br label %CH_STB2

CH_ELSE_BLOCK59:                                  ; preds = %CH_ELSE_BLOCK54
  %CH_OFFSET60 = mul i64 4, %4
  %CH_LEFT61 = add i64 %CH_OFFSET60, 6293888
  %CH_COND62 = icmp ult i64 %CH_LEFT61, 6294656
  br i1 %CH_COND62, label %CH_TRUE_BLOCK68, label %CH_ELSE_BLOCK64

CH_TRUE_BLOCK63:                                  ; preds = %CH_ELSE_BLOCK54
  call void @__CSIM_Store(i64 24588, i64 0)
  br label %CH_STB2

CH_ELSE_BLOCK64:                                  ; preds = %CH_ELSE_BLOCK59
  %CH_OFFSET65 = mul i64 4, %4
  %CH_LEFT66 = add i64 %CH_OFFSET65, 6293888
  %CH_COND67 = icmp ult i64 %CH_LEFT66, 6294688
  br i1 %CH_COND67, label %CH_TRUE_BLOCK69, label %CH_STB2

CH_TRUE_BLOCK68:                                  ; preds = %CH_ELSE_BLOCK59
  call void @__CSIM_Store(i64 24588, i64 1)
  br label %CH_STB2

CH_TRUE_BLOCK69:                                  ; preds = %CH_ELSE_BLOCK64
  call void @__CSIM_Store(i64 24588, i64 2)
  br label %CH_STB2

CH_ELSE_BLOCK73:                                  ; preds = %CH_LDB7
  %CH_OFFSET74 = mul i64 4, %17
  %CH_LEFT75 = add i64 %CH_OFFSET74, 6293888
  %CH_COND76 = icmp ult i64 %CH_LEFT75, 6294016
  br i1 %CH_COND76, label %CH_TRUE_BLOCK82, label %CH_ELSE_BLOCK78

CH_TRUE_BLOCK77:                                  ; preds = %CH_LDB7
  call void @__CSIM_Store(i64 24585, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK78:                                  ; preds = %CH_ELSE_BLOCK73
  %CH_OFFSET79 = mul i64 4, %17
  %CH_LEFT80 = add i64 %CH_OFFSET79, 6293888
  %CH_COND81 = icmp ult i64 %CH_LEFT80, 6294080
  br i1 %CH_COND81, label %CH_TRUE_BLOCK87, label %CH_ELSE_BLOCK83

CH_TRUE_BLOCK82:                                  ; preds = %CH_ELSE_BLOCK73
  call void @__CSIM_Store(i64 24585, i64 3)
  br label %CH_LDB10

CH_ELSE_BLOCK83:                                  ; preds = %CH_ELSE_BLOCK78
  %CH_OFFSET84 = mul i64 4, %17
  %CH_LEFT85 = add i64 %CH_OFFSET84, 6293888
  %CH_COND86 = icmp ult i64 %CH_LEFT85, 6294144
  br i1 %CH_COND86, label %CH_TRUE_BLOCK92, label %CH_ELSE_BLOCK88

CH_TRUE_BLOCK87:                                  ; preds = %CH_ELSE_BLOCK78
  call void @__CSIM_Store(i64 24586, i64 0)
  br label %CH_LDB10

CH_ELSE_BLOCK88:                                  ; preds = %CH_ELSE_BLOCK83
  %CH_OFFSET89 = mul i64 4, %17
  %CH_LEFT90 = add i64 %CH_OFFSET89, 6293888
  %CH_COND91 = icmp ult i64 %CH_LEFT90, 6294208
  br i1 %CH_COND91, label %CH_TRUE_BLOCK97, label %CH_ELSE_BLOCK93

CH_TRUE_BLOCK92:                                  ; preds = %CH_ELSE_BLOCK83
  call void @__CSIM_Store(i64 24586, i64 1)
  br label %CH_LDB10

CH_ELSE_BLOCK93:                                  ; preds = %CH_ELSE_BLOCK88
  %CH_OFFSET94 = mul i64 4, %17
  %CH_LEFT95 = add i64 %CH_OFFSET94, 6293888
  %CH_COND96 = icmp ult i64 %CH_LEFT95, 6294272
  br i1 %CH_COND96, label %CH_TRUE_BLOCK102, label %CH_ELSE_BLOCK98

CH_TRUE_BLOCK97:                                  ; preds = %CH_ELSE_BLOCK88
  call void @__CSIM_Store(i64 24586, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK98:                                  ; preds = %CH_ELSE_BLOCK93
  %CH_OFFSET99 = mul i64 4, %17
  %CH_LEFT100 = add i64 %CH_OFFSET99, 6293888
  %CH_COND101 = icmp ult i64 %CH_LEFT100, 6294336
  br i1 %CH_COND101, label %CH_TRUE_BLOCK107, label %CH_ELSE_BLOCK103

CH_TRUE_BLOCK102:                                 ; preds = %CH_ELSE_BLOCK93
  call void @__CSIM_Store(i64 24586, i64 3)
  br label %CH_LDB10

CH_ELSE_BLOCK103:                                 ; preds = %CH_ELSE_BLOCK98
  %CH_OFFSET104 = mul i64 4, %17
  %CH_LEFT105 = add i64 %CH_OFFSET104, 6293888
  %CH_COND106 = icmp ult i64 %CH_LEFT105, 6294400
  br i1 %CH_COND106, label %CH_TRUE_BLOCK112, label %CH_ELSE_BLOCK108

CH_TRUE_BLOCK107:                                 ; preds = %CH_ELSE_BLOCK98
  call void @__CSIM_Store(i64 24587, i64 0)
  br label %CH_LDB10

CH_ELSE_BLOCK108:                                 ; preds = %CH_ELSE_BLOCK103
  %CH_OFFSET109 = mul i64 4, %17
  %CH_LEFT110 = add i64 %CH_OFFSET109, 6293888
  %CH_COND111 = icmp ult i64 %CH_LEFT110, 6294464
  br i1 %CH_COND111, label %CH_TRUE_BLOCK117, label %CH_ELSE_BLOCK113

CH_TRUE_BLOCK112:                                 ; preds = %CH_ELSE_BLOCK103
  call void @__CSIM_Store(i64 24587, i64 1)
  br label %CH_LDB10

CH_ELSE_BLOCK113:                                 ; preds = %CH_ELSE_BLOCK108
  %CH_OFFSET114 = mul i64 4, %17
  %CH_LEFT115 = add i64 %CH_OFFSET114, 6293888
  %CH_COND116 = icmp ult i64 %CH_LEFT115, 6294528
  br i1 %CH_COND116, label %CH_TRUE_BLOCK122, label %CH_ELSE_BLOCK118

CH_TRUE_BLOCK117:                                 ; preds = %CH_ELSE_BLOCK108
  call void @__CSIM_Store(i64 24587, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK118:                                 ; preds = %CH_ELSE_BLOCK113
  %CH_OFFSET119 = mul i64 4, %17
  %CH_LEFT120 = add i64 %CH_OFFSET119, 6293888
  %CH_COND121 = icmp ult i64 %CH_LEFT120, 6294592
  br i1 %CH_COND121, label %CH_TRUE_BLOCK127, label %CH_ELSE_BLOCK123

CH_TRUE_BLOCK122:                                 ; preds = %CH_ELSE_BLOCK113
  call void @__CSIM_Store(i64 24587, i64 3)
  br label %CH_LDB10

CH_ELSE_BLOCK123:                                 ; preds = %CH_ELSE_BLOCK118
  %CH_OFFSET124 = mul i64 4, %17
  %CH_LEFT125 = add i64 %CH_OFFSET124, 6293888
  %CH_COND126 = icmp ult i64 %CH_LEFT125, 6294656
  br i1 %CH_COND126, label %CH_TRUE_BLOCK132, label %CH_ELSE_BLOCK128

CH_TRUE_BLOCK127:                                 ; preds = %CH_ELSE_BLOCK118
  call void @__CSIM_Store(i64 24588, i64 0)
  br label %CH_LDB10

CH_ELSE_BLOCK128:                                 ; preds = %CH_ELSE_BLOCK123
  %CH_OFFSET129 = mul i64 4, %17
  %CH_LEFT130 = add i64 %CH_OFFSET129, 6293888
  %CH_COND131 = icmp ult i64 %CH_LEFT130, 6294688
  br i1 %CH_COND131, label %CH_TRUE_BLOCK133, label %CH_LDB10

CH_TRUE_BLOCK132:                                 ; preds = %CH_ELSE_BLOCK123
  call void @__CSIM_Store(i64 24588, i64 1)
  br label %CH_LDB10

CH_TRUE_BLOCK133:                                 ; preds = %CH_ELSE_BLOCK128
  call void @__CSIM_Store(i64 24588, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK137:                                 ; preds = %CH_LDB8
  %CH_OFFSET138 = mul i64 4, %21
  %CH_LEFT139 = add i64 %CH_OFFSET138, 6293888
  %CH_COND140 = icmp ult i64 %CH_LEFT139, 6294016
  br i1 %CH_COND140, label %CH_TRUE_BLOCK146, label %CH_ELSE_BLOCK142

CH_TRUE_BLOCK141:                                 ; preds = %CH_LDB8
  call void @__CSIM_Store(i64 24585, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK142:                                 ; preds = %CH_ELSE_BLOCK137
  %CH_OFFSET143 = mul i64 4, %21
  %CH_LEFT144 = add i64 %CH_OFFSET143, 6293888
  %CH_COND145 = icmp ult i64 %CH_LEFT144, 6294080
  br i1 %CH_COND145, label %CH_TRUE_BLOCK151, label %CH_ELSE_BLOCK147

CH_TRUE_BLOCK146:                                 ; preds = %CH_ELSE_BLOCK137
  call void @__CSIM_Store(i64 24585, i64 3)
  br label %CH_LDB10

CH_ELSE_BLOCK147:                                 ; preds = %CH_ELSE_BLOCK142
  %CH_OFFSET148 = mul i64 4, %21
  %CH_LEFT149 = add i64 %CH_OFFSET148, 6293888
  %CH_COND150 = icmp ult i64 %CH_LEFT149, 6294144
  br i1 %CH_COND150, label %CH_TRUE_BLOCK156, label %CH_ELSE_BLOCK152

CH_TRUE_BLOCK151:                                 ; preds = %CH_ELSE_BLOCK142
  call void @__CSIM_Store(i64 24586, i64 0)
  br label %CH_LDB10

CH_ELSE_BLOCK152:                                 ; preds = %CH_ELSE_BLOCK147
  %CH_OFFSET153 = mul i64 4, %21
  %CH_LEFT154 = add i64 %CH_OFFSET153, 6293888
  %CH_COND155 = icmp ult i64 %CH_LEFT154, 6294208
  br i1 %CH_COND155, label %CH_TRUE_BLOCK161, label %CH_ELSE_BLOCK157

CH_TRUE_BLOCK156:                                 ; preds = %CH_ELSE_BLOCK147
  call void @__CSIM_Store(i64 24586, i64 1)
  br label %CH_LDB10

CH_ELSE_BLOCK157:                                 ; preds = %CH_ELSE_BLOCK152
  %CH_OFFSET158 = mul i64 4, %21
  %CH_LEFT159 = add i64 %CH_OFFSET158, 6293888
  %CH_COND160 = icmp ult i64 %CH_LEFT159, 6294272
  br i1 %CH_COND160, label %CH_TRUE_BLOCK166, label %CH_ELSE_BLOCK162

CH_TRUE_BLOCK161:                                 ; preds = %CH_ELSE_BLOCK152
  call void @__CSIM_Store(i64 24586, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK162:                                 ; preds = %CH_ELSE_BLOCK157
  %CH_OFFSET163 = mul i64 4, %21
  %CH_LEFT164 = add i64 %CH_OFFSET163, 6293888
  %CH_COND165 = icmp ult i64 %CH_LEFT164, 6294336
  br i1 %CH_COND165, label %CH_TRUE_BLOCK171, label %CH_ELSE_BLOCK167

CH_TRUE_BLOCK166:                                 ; preds = %CH_ELSE_BLOCK157
  call void @__CSIM_Store(i64 24586, i64 3)
  br label %CH_LDB10

CH_ELSE_BLOCK167:                                 ; preds = %CH_ELSE_BLOCK162
  %CH_OFFSET168 = mul i64 4, %21
  %CH_LEFT169 = add i64 %CH_OFFSET168, 6293888
  %CH_COND170 = icmp ult i64 %CH_LEFT169, 6294400
  br i1 %CH_COND170, label %CH_TRUE_BLOCK176, label %CH_ELSE_BLOCK172

CH_TRUE_BLOCK171:                                 ; preds = %CH_ELSE_BLOCK162
  call void @__CSIM_Store(i64 24587, i64 0)
  br label %CH_LDB10

CH_ELSE_BLOCK172:                                 ; preds = %CH_ELSE_BLOCK167
  %CH_OFFSET173 = mul i64 4, %21
  %CH_LEFT174 = add i64 %CH_OFFSET173, 6293888
  %CH_COND175 = icmp ult i64 %CH_LEFT174, 6294464
  br i1 %CH_COND175, label %CH_TRUE_BLOCK181, label %CH_ELSE_BLOCK177

CH_TRUE_BLOCK176:                                 ; preds = %CH_ELSE_BLOCK167
  call void @__CSIM_Store(i64 24587, i64 1)
  br label %CH_LDB10

CH_ELSE_BLOCK177:                                 ; preds = %CH_ELSE_BLOCK172
  %CH_OFFSET178 = mul i64 4, %21
  %CH_LEFT179 = add i64 %CH_OFFSET178, 6293888
  %CH_COND180 = icmp ult i64 %CH_LEFT179, 6294528
  br i1 %CH_COND180, label %CH_TRUE_BLOCK186, label %CH_ELSE_BLOCK182

CH_TRUE_BLOCK181:                                 ; preds = %CH_ELSE_BLOCK172
  call void @__CSIM_Store(i64 24587, i64 2)
  br label %CH_LDB10

CH_ELSE_BLOCK182:                                 ; preds = %CH_ELSE_BLOCK177
  %CH_OFFSET183 = mul i64 4, %21
  %CH_LEFT184 = add i64 %CH_OFFSET183, 6293888
  %CH_COND185 = icmp ult i64 %CH_LEFT184, 6294592
  br i1 %CH_COND185, label %CH_TRUE_BLOCK191, label %CH_ELSE_BLOCK187

CH_TRUE_BLOCK186:                                 ; preds = %CH_ELSE_BLOCK177
  call void @__CSIM_Store(i64 24587, i64 3)
  br label %CH_LDB10

CH_ELSE_BLOCK187:                                 ; preds = %CH_ELSE_BLOCK182
  %CH_OFFSET188 = mul i64 4, %21
  %CH_LEFT189 = add i64 %CH_OFFSET188, 6293888
  %CH_COND190 = icmp ult i64 %CH_LEFT189, 6294656
  br i1 %CH_COND190, label %CH_TRUE_BLOCK196, label %CH_ELSE_BLOCK192

CH_TRUE_BLOCK191:                                 ; preds = %CH_ELSE_BLOCK182
  call void @__CSIM_Store(i64 24588, i64 0)
  br label %CH_LDB10

CH_ELSE_BLOCK192:                                 ; preds = %CH_ELSE_BLOCK187
  %CH_OFFSET193 = mul i64 4, %21
  %CH_LEFT194 = add i64 %CH_OFFSET193, 6293888
  %CH_COND195 = icmp ult i64 %CH_LEFT194, 6294688
  br i1 %CH_COND195, label %CH_TRUE_BLOCK197, label %CH_LDB10

CH_TRUE_BLOCK196:                                 ; preds = %CH_ELSE_BLOCK187
  call void @__CSIM_Store(i64 24588, i64 1)
  br label %CH_LDB10

CH_TRUE_BLOCK197:                                 ; preds = %CH_ELSE_BLOCK192
  call void @__CSIM_Store(i64 24588, i64 2)
  br label %CH_LDB10
}
...
; <label>:46                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8]* @.str14, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str15, i32 0, i32 0), i32 65, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
...
; <label>:51                                      ; preds = %47
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8]* @.str16, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str15, i32 0, i32 0), i32 66, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
