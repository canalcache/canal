...
int main () 
{
	...
	__CSIM_init_cache();
    __CSIM_MAIN__(a2);
	access1 = __CSIM_num_Store_miss + __CSIM_num_Load_miss + __CSIM_num_Store_hit + __CSIM_num_Load_hit;
	miss1 = __CSIM_num_Store_miss + __CSIM_num_Load_miss;
	
	__CSIM_init_cache();
    __CSIM_MAIN__(a1);
	access2 = __CSIM_num_Store_miss + __CSIM_num_Load_miss + __CSIM_num_Store_hit + __CSIM_num_Load_hit;
