...
CH_LDB16:                                         ; preds = %CH_LDB27, %26
  ...
  br i1 %28, label %CH_LDB17, label %48
...
CH_LDB20:                                         ; preds = %CH_TRUE_BLOCK470, %CH_TRUE_BLOCK469, %CH_ELSE_BLOCK465, %CH_TRUE_BLOCK464, %CH_TRUE_BLOCK459, %CH_TRUE_BLOCK454, %CH_TRUE_BLOCK449, %CH_TRUE_BLOCK444, %CH_TRUE_BLOCK439, %CH_TRUE_BLOCK434, %CH_
  ...
  br i1 %37, label %CH_STB21, label %CH_LDB24

CH_STB21:                                         ; preds = %CH_LDB20
...
CH_LDB23:                                         ; preds = %CH_TRUE_BLOCK534, %CH_TRUE_BLOCK533, %CH_ELSE_BLOCK529, %CH_TRUE_BLOCK528, %CH_TRUE_BLOCK523, %CH_TRUE_BLOCK518, %CH_TRUE_BLOCK513, %CH_TRUE_BLOCK508, %CH_TRUE_BLOCK503, %CH_TRUE_BLOCK498, %CH_
...
CH_LDB24:                                         ; preds = %CH_LDB20
  ...
  %44 = getelementptr inbounds [200 x i32]* @a1, i32 0, i64 %43
  %45 = load i32* %44, align 4
  %CH_OFFSET535 = mul i64 4, %43
  %CH_LEFT536 = add i64 %CH_OFFSET535, 6296256
  %CH_COND537 = icmp ult i64 %CH_LEFT536, 6296320
  br i1 %CH_COND537, label %CH_TRUE_BLOCK542, label %CH_ELSE_BLOCK538
...
CH_LDB25:                                         ; preds = %CH_TRUE_BLOCK598, %CH_TRUE_BLOCK597, %CH_ELSE_BLOCK593, %CH_TRUE_BLOCK592, %CH_TRUE_BLOCK587, %CH_TRUE_BLOCK582, %CH_TRUE_BLOCK577, %CH_TRUE_BLOCK572, %CH_TRUE_BLOCK567, %CH_TRUE_BLOCK562, %CH_
  store i32 %45, i32* getelementptr inbounds ([200 x i32]* @a2, i32 0, i64 199), align 4
  call void @__CSIM_Store(i64 24601, i64 1)
  store i32 5, i32* getelementptr inbounds ([200 x i32]* @a2, i32 0, i64 199), align 4
  call void @__CSIM_Store(i64 24601, i64 1)
  br label %CH_LDB27

CH_LDB27:                                         ; preds = %CH_LDB23, %CH_LDB25
  %46 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24598, i64 0)
  %47 = add nsw i32 %46, 1
  store i32 %47, i32* @i, align 64
  call void @__CSIM_Store(i64 24598, i64 0)
  br label %CH_LDB16

; <label>:48                                      ; preds = %CH_LDB16
  ret void
...
CH_ELSE_BLOCK474:                                 ; preds = %CH_STB21
...
CH_TRUE_BLOCK478:                                 ; preds = %CH_STB21
  call void @__CSIM_Load(i64 24594, i64 3)
  br label %CH_LDB23
...
CH_ELSE_BLOCK529:                                 ; preds = %CH_ELSE_BLOCK524
  ...
  br i1 %CH_COND532, label %CH_TRUE_BLOCK534, label %CH_LDB23
