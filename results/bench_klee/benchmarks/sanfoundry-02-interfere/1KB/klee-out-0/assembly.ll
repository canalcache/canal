...
CH_STB:
  ...
  br i1 %12, label %CH_LDB17, label %16

CH_LDB17:                                         ; preds = %CH_STB
  %13 = load i32* @largest1, align 64
  call void @__CSIM_Load(i64 24587, i64 1)
  store i32 %13, i32* @temp, align 64
  call void @__CSIM_Store(i64 24587, i64 2)
  %14 = load i32* @largest2, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  store i32 %14, i32* @largest1, align 64
  call void @__CSIM_Store(i64 24587, i64 1)
  %15 = load i32* @temp, align 64
  call void @__CSIM_Load(i64 24587, i64 2)
  store i32 %15, i32* @largest2, align 64
  call void @__CSIM_Store(i64 24586, i64 3)
  br label %16

; <label>:16                                      ; preds = %CH_LDB17, %CH_STB
  store i32 2, i32* @i, align 64
  call void @__CSIM_Store(i64 24587, i64 0)
  br label %CH_LDB22

CH_LDB22:                                         ; preds = %CH_LDB35, %16
  %17 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24587, i64 0)
  %18 = icmp slt i32 %17, 4
  br i1 %18, label %CH_LDB23, label %42

CH_LDB23:                                         ; preds = %CH_LDB22
  %19 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24587, i64 0)
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [4 x i32]* @array, i32 0, i64 %20
  %22 = load i32* %21, align 4
  %CH_OFFSET = mul i64 4, %20
  %CH_LEFT = add i64 %CH_OFFSET, 6294144
  %CH_COND = icmp ult i64 %CH_LEFT, 6294160
  br i1 %CH_COND, label %CH_TRUE_BLOCK, label %CH_LDB24

CH_LDB24:                                         ; preds = %CH_TRUE_BLOCK, %CH_LDB23
  %23 = load i32* @largest1, align 64
  call void @__CSIM_Load(i64 24587, i64 1)
  %24 = icmp sge i32 %22, %23
  br i1 %24, label %CH_LDB26, label %CH_LDB30

CH_LDB26:                                         ; preds = %CH_LDB24
  %25 = load i32* @largest1, align 64
  call void @__CSIM_Load(i64 24587, i64 1)
  store i32 %25, i32* @largest2, align 64
  call void @__CSIM_Store(i64 24586, i64 3)
  %26 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24587, i64 0)
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [4 x i32]* @array, i32 0, i64 %27
  %29 = load i32* %28, align 4
  %CH_OFFSET36 = mul i64 4, %27
  %CH_LEFT37 = add i64 %CH_OFFSET36, 6294144
  %CH_COND38 = icmp ult i64 %CH_LEFT37, 6294160
  br i1 %CH_COND38, label %CH_TRUE_BLOCK39, label %CH_LDB29

CH_LDB29:                                         ; preds = %CH_TRUE_BLOCK39, %CH_LDB26
  store i32 %29, i32* @largest1, align 64
  call void @__CSIM_Store(i64 24587, i64 1)
  br label %CH_LDB35

CH_LDB30:                                         ; preds = %CH_LDB24
  %30 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24587, i64 0)
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [4 x i32]* @array, i32 0, i64 %31
  %33 = load i32* %32, align 4
  %CH_OFFSET40 = mul i64 4, %31
  %CH_LEFT41 = add i64 %CH_OFFSET40, 6294144
  %CH_COND42 = icmp ult i64 %CH_LEFT41, 6294160
  br i1 %CH_COND42, label %CH_TRUE_BLOCK43, label %CH_LDB31

CH_LDB31:                                         ; preds = %CH_TRUE_BLOCK43, %CH_LDB30
  %34 = load i32* @largest2, align 64
  call void @__CSIM_Load(i64 24586, i64 3)
  %35 = icmp sgt i32 %33, %34
  br i1 %35, label %CH_LDB33, label %CH_LDB35

CH_LDB33:                                         ; preds = %CH_LDB31
  %36 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24587, i64 0)
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [4 x i32]* @array, i32 0, i64 %37
  %39 = load i32* %38, align 4
  %CH_OFFSET44 = mul i64 4, %37
  %CH_LEFT45 = add i64 %CH_OFFSET44, 6294144
  %CH_COND46 = icmp ult i64 %CH_LEFT45, 6294160
  br i1 %CH_COND46, label %CH_TRUE_BLOCK47, label %CH_LDB34

CH_LDB34:                                         ; preds = %CH_TRUE_BLOCK47, %CH_LDB33
  store i32 %39, i32* @largest2, align 64
  call void @__CSIM_Store(i64 24586, i64 3)
  br label %CH_LDB35

CH_LDB35:                                         ; preds = %CH_LDB29, %CH_LDB34, %CH_LDB31
  %40 = load i32* @i, align 64
  call void @__CSIM_Load(i64 24587, i64 0)
  %41 = add nsw i32 %40, 1
  store i32 %41, i32* @i, align 64
  call void @__CSIM_Store(i64 24587, i64 0)
  br label %CH_LDB22

; <label>:42                                      ; preds = %CH_LDB22
  ret i32 0

CH_TRUE_BLOCK:                                    ; preds = %CH_LDB23
  call void @__CSIM_Load(i64 24586, i64 2)
  br label %CH_LDB24

CH_TRUE_BLOCK39:                                  ; preds = %CH_LDB26
  call void @__CSIM_Load(i64 24586, i64 2)
  br label %CH_LDB29

CH_TRUE_BLOCK43:                                  ; preds = %CH_LDB30
  call void @__CSIM_Load(i64 24586, i64 2)
  br label %CH_LDB31

CH_TRUE_BLOCK47:                                  ; preds = %CH_LDB33
  call void @__CSIM_Load(i64 24586, i64 2)
  br label %CH_LDB34
}
...
; <label>:55                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8]* @.str20, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str21, i32 0, i32 0), i32 81, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
...
; <label>:60                                      ; preds = %56
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str22, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str21, i32 0, i32 0), i32 82, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #5
  unreachable
