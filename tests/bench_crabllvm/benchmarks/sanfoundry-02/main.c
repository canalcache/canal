...
void __CSIM_MAIN__()
{
    ...
    __CRAB_assert(__CSIM_num_Store > 1); // [3, inf.]
    __CRAB_assert(__CSIM_num_Store_hit > 1);    // [0, inf.]
    __CRAB_assert(__CSIM_num_Store_miss > 1);   // [3, inf.]
    __CRAB_assert(__CSIM_num_Load > 1);  // [5, inf.]
    __CRAB_assert(__CSIM_num_Load_hit > 1);     // [4, inf.]
    __CRAB_assert(__CSIM_num_Load_miss > 1);    // [1, inf.]
